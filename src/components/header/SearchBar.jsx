...
function SearchBar() {
    return (
        <div className='flex justify-start items-center lg:gap-[34px] gap-5 bg-secondary pl-5 py-[7px] pr-3'>
            <input type="text" placeholder='What are you looking for?' className='w-[153px] bg-secondary focus:outline-none text-[12px] leading-[18px]' />
