  ...
  return (
    <div className='xl:w-[1170px] w-11/12 mx-auto'>
      <div className='text-center py-[15px] bg-black'>
        <p className=' text-secondary1 font-normal font-poppins text-sm'>Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%! <Link className='font-semibold pl-2 leading-6 underline' to='#shop'> ShopNow </Link></p>
      </div>

      <div className='border-b-[.5px] border-[#b3b3b3]'>
        <div className=' pt-10 pb-4 '>
          <div className='flex md:flex-row flex-col justify-between gap-6 py-[7px]'>
