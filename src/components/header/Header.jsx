    ...
    <>
      ...
      <div className='py-[15px] bg-black '>
        <div className='text-center xl:w-[1170px] w-11/12 mx-auto flex lg:justify-end justify-between items-center lg:gap-[231px] gap-4'>
          ...
          {/* language selector  */}
          <select className=' border-none cursor-pointer bg-black pr-[11px] font-poppins font-normal rounded-md text-sm text-secondary1 focus:outline-hidden  focus:border-none'>
